...
def solve_part_1(raw_input: str, room_size=(101, 103)):
    ...
    nw = [r for r in robots if 0 <= r.p_xy[0] < x_half and 0 < r.p_xy[1] < y_half]
    ne = [r for r in robots if x_half < r.p_xy[0] and 0 <= r.p_xy[1] < y_half]
    sw = [r for r in robots if 0 <= r.p_xy[0] < x_half and y_half < r.p_xy[1]]
    se = [r for r in robots if x_half < r.p_xy[0] and y_half < r.p_xy[1]]
